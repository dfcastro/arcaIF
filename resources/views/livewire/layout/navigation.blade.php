        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Link para Animais -->
                    <x-nav-link :href="url('/animais')" :active="request()->is('animais')">
                        {{ __('Animais') }}
                    </x-nav-link>
                    <!-- NOVO LINK PARA ESPÉCIES -->
                    <x-nav-link :href="url('/especies')" :active="request()->is('especies')">
                        {{ __('Espécies') }}
                    </x-nav-link>
                    <x-nav-link :href="url('/racas')" :active="request()->is('racas')">
                        {{ __('Raças') }}
                    </x-nav-link>
                    <x-nav-link :href="url('/lotes')" :active="request()->is('lotes')">
                        {{ __('Lotes') }}
                    </x-nav-link>
