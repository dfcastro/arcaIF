            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center mb-6">
                        ...
                        {{-- Container modificado para alinhar Busca e Botão --}}
                        <div class="flex flex-col md:flex-row md:items-center md:justify-end gap-3">
                            ...
                            <div class="relative w-full md:w-64">
                                ...
                                <input wire:model.live.debounce.300ms="search" type="text"
                                    ...
                                    placeholder="Buscar raça ou espécie...">
                            </div>

                            @can('access-admin-area')
                                <x-primary-button wire:click="abrirModal()" class="w-full md:w-auto justify-center">
                                ...
                                @forelse ($racas as $raca)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td
                                            ...
                                            @endcan
                                            <button wire:click="confirmarDelecao({{ $raca->id }})"
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        <button wire:click="deletar()" type="button"
                            class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 sm:ml-3 sm:w-auto sm:text-sm">
                            Confirmar Exclusão
                        </button>
                        <button wire:click="$set('modalDelecaoAberto', false)" type="button"
                            class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                            Cancelar
                        </button>
                    </div>
