                                    ...
                                    <div class="flex justify-between items-center mb-4 print:hidden">
                                        <div>
                                            ...
                                            @elseif($tipoRelatorio === 'historico_pesagem' && $animalSelecionado)
                                                <h3 class="text-xl font-bold">Relatório de Pesagem: {{ $animalSelecionado->identificacao }}</h3>
                                            @elseif($tipoRelatorio === 'historico_vacinacao' && $animalSelecionado)
                                                <h3 class="text-xl font-bold">Relatório de Vacinação: {{ $animalSelecionado->identificacao }}</h3>
                                        ...
                                        <button @click="imprimirRelatorio()" class="px-4 py-2 text-sm text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300">
                                                    ...
                                                    @forelse($dadosRelatorio as $movimentacao)
                                                        <tr>
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                                <a href="{{ route('animais.show', $movimentacao->animal) }}" class="text-indigo-600 hover:text-indigo-900">
