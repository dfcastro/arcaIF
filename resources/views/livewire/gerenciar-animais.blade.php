                                    ...
                                    @forelse ($animais as $animal)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {{ $animal->especie->nome }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {{ $animal->raca->nome ?? 'N/D' }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {{ $animal->sexo }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {{ \Carbon\Carbon::parse($animal->data_nascimento)->format('d/m/Y') }}
                                            </td>
                                            ...
                                            <td
                                                ...
                                                <button wire:click="editar({{ $animal->id }})"
                                                    class="text-indigo-600 hover:text-indigo-900" title="Editar">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </button>
                                                <button wire:click="deletar({{ $animal->id }})"
                                                    wire:confirm="Tem certeza que deseja remover este animal?"
                                        ...
                                        <tr>
                                            <td colspan="7" class="px-6 py-12 text-center">
                                                <div class="text-center">
                                                    ...
                                                    <h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum animal
                                                        encontrado</h3>
                                                    <p class="mt-1 text-sm text-gray-500">Comece cadastrando um novo
                                                        animal.</p>
                                                </div>
                                            </td>
                                        </tr>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="col-span-1">
                                    ...
                                    <select wire:model="raca_id" id="raca_id"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @if (empty($racas)) bg-gray-100 cursor-not-allowed @endif"
                                        @if (empty($racas)) disabled @endif>
                                        <option value="">Selecione...</option>
                                ...
                                <div class="md:col-span-2">
                                    <label for="identificacao"
                                        class="block text-sm font-medium text-gray-700">Identificação</label>
                                    <input type="text" wire:model="identificacao" id="identificacao"
                                        placeholder="Ex: Brinco 123, nome 'Mimoso'"
                                ...
                                <div>
                                    <label for="data_nascimento" class="block text-sm font-medium text-gray-700">Data
                                        de Nascimento</label>
                                    <input type="date" wire:model="data_nascimento" id="data_nascimento"
                                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
